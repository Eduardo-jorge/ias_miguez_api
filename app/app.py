...
def healthcheck():
  #  return jsonify({"status": "ok", "message": "API funcionando correctamente - Prueba CI/CD"}), 200
return jsonify({"status": "ok", "message": "API funcionando correctamente - Prueba CI/CD 10/06"}), 200
